...
![Version: 1.2.14](https://img.shields.io/badge/Version-1.2.13-informational?style=flat-square) ![AppVersion: 1.2.5](https://img.shields.io/badge/AppVersion-1.2.5-informational?style=flat-square)
...
| loki.schema_config.configs[0].object_store | string | `"filesystem"` |  |
| loki.schema_config.configs[0].schema | string | `"v12"` |  |
